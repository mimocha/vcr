    ...
    <Card title="Your Critical Velocity">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className={`
          ...
          ${isDark ? 'bg-blue-500/10 border-blue-400/30' : 'bg-blue-50/80 border-blue-200'}
        `}>
          <p className={`text-sm font-medium mb-1 ${isDark ? 'text-blue-300' : 'text-blue-600'}`}>
            CV (m/s)
          </p>
        ...
        {d_prime !== undefined && (
          <div className={`
            ...
            ${isDark ? 'bg-green-500/10 border-green-400/30' : 'bg-green-50/80 border-green-200'}
          `}>
            <p className={`text-sm font-medium mb-1 ${isDark ? 'text-green-300' : 'text-green-600'}`}>
